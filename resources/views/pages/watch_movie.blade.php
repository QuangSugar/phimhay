    ...
    <div class="row container" id="wrapper">
        <div class="halim-panel-filter">
            <div class="panel-heading">
               <div class="row">
                  <div class="col-xs-6">
                     <div class="yoast_breadcrumb hidden-xs"><span><span><a href="{{URL::to('/')}}">Trang chủ</a> » <span><a href="danhmuc.php">{{$movie->movie_name}}</a> » <span class="breadcrumb_last" aria-current="page">{{$video->eposide_name}}</span></span></span></span></div>
                  </div>
               </div>
            </div>
         ...
         <main id="main-contents" class="col-xs-12 col-sm-12 col-md-8">
            <section id="content" class="test">
               <div class="clearfix wrap-content">
                  ...
                  <iframe width="100%" height="500" src="{{$video->eposide_video}}" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                  ...
                  <div class="title-block">
                     ...
                     {{-- <div class="title-wrapper-xem full">
                        <h1 class="entry-title"><a href="" title="{{$movie->movie_name}}" class="tl">{{$movie->movie_name}} {{$video->eposide_name}}</a></h1>
                     </div> --}}
                  </div>
                  ...
                  <div id="halim-list-server">
                     <ul class="nav nav-tabs" role="tablist">
                        <li role="presentation" class="active server-1"><a href="#server-0" aria-controls="server-0" role="tab" data-toggle="tab"><i class="hl-server"></i> {{$movie->movie_language}}</a></li>
                     </ul>
                        ...
                        <div role="tabpanel" class="tab-pane active server-1" id="server-0">
                           <div class="halim-server">
                              <ul class="halim-list-eps">
                                  ...
                                  <li class="halim-episode"><a href="{{URL::to('/'.$movie->movie_slug.'_'.$movie->movie_id.'/'.$value->eposide_slug)}}"><span class="halim-btn halim-btn-2 active halim-info-1-1 box-shadow" >{{$value->eposide_name}}</span></a></li>
                                  @endforeach
